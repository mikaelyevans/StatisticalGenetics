...
You now have the skills to implement a Genome-Wide Association Study and plot your findings! In order to implement this on all chromosomes, follow the same code, but do not filter to only select SNPs on chromosome 1. This will allow you to loop through all the SNPs on all the chromosomes and may take up to 30 minutes to run!
